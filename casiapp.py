# -*- coding: utf-8 -*-
"""
Created on Sat May 16 09:12:48 2020
...
class Interfaz(object):
    def __init__(self, root):
        ...
        #self.fuente.botones = font.Font(family='Helvetica', size=8, weight='bold')
...
#        ax=plt.subplot(111)
#        ax.axis('off') 
#        ax.table(cellText=df_2.values, colColours=['#8CE5F9']*df_2.shape[1], bbox=[0, 0, 1, 1], colLabels=df_2.columns)                                   
#        plt.show()
#    
    def exportar(self):
